...
int assemble_account_number(int secret_modifier) {
  int assembled_account_number{garcia::bank_number_part(secret_modifier) +
...
int assemble_code() {
  int red_combined{garcia::red::code_fragment() + khan::red::code_fragment() +
                   zhang::red::code_fragment()};

  int blue_combined{garcia::blue::code_fragment() +
                    khan::blue::code_fragment() + zhang::blue::code_fragment()};

  int combined{red_combined * blue_combined};
  return combined;
}
} // namespace estate_executor
